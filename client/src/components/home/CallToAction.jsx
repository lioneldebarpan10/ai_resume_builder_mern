...
const CallToAction = () => {
   return (
      <>
         <div id='cta' className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30 mt-20">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3C5EB] to-[#FFFFFF]">
               <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                  ...
                  <span className="bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent font-medium">Trusted by Experts</span>
               </div>
               <h2 className="text-2xl md:text-4xl font-medium mt-5 leading-[1.2]">
                  Build a  Professional Resume that helps you to <br />
                  <span className="bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent"> stand out </span>
                  from the crowd and get hired
               </h2>
               <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">Create and Edit your resume with AI suggestions</p>
               <Link to='/app' className="bg-violet-500 hover:bg-violet-700 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-purple-400 flex items-center transition-colors mt-7">
                  Get started
